...
const StorageData = styled(Box)(({ theme }) => ({
  display: "flex",
...
function StorageToWork() {
  ...
  const ImageWidth = () => {
    ...
    if (isMeduimScreen) return "260px";
        ...
        <StorageData>
          <StorageText>
            ...
            >
              ...
              means your earnings will increase. Below you'll see what a blobber
              earns on average after a Node is vetted as reliable on the
              network.
              <br></br>
              <br></br>
              Once your Node is verified, you'll start being compensated for the
              storage and bandwidth you provide. Every month you meet the
